...
export default async function ReportPreview({ searchParams }: { searchParams: Promise<{ scenario?: string }> }) {
  ...
  const draft: VisitDraft = { id: report.draftId, createdAt: report.generatedAt, patient: { name: "Fictional preview", age: 64, sex: "F" }, transcript: { text: urdu, language: "ur", words: [] }, reviewedUrdu: urdu, seconds: 0, status: "transcript-ready", report };
