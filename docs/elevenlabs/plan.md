...
> Historical proposal/research by Rayyan, retained for attribution. Superseded as implementation guidance by the Scribe-only integration in `README.md`, ADR 0008 and the current build order. Provider/prize/accuracy claims below are historical notes, not newly verified facts.
