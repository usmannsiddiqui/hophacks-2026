...
Open a visit and click Use the sample Urdu recording next to Start recording. It runs the real pipeline and produces a genuine high severity flag based on the drug mixes for instances when Tylenol and Panadol are taken, they are both paracetamol, and together they can reach a liver damaging dose.
